classdef (InferiorClasses = {?intervalMatrix, ?matZonotope}) zonotopempt
...
methods
    ...
    function Obj = zonotopempt(varargin)
        ...
        elseif isa(varargin{1}, 'zonotopempt')
            Obj = varargin{1};
