...
if isa(numerator, 'intervalmpt') == 1 && isa(denominator, 'intervalmpt') == 0
...
% a (matrix of) scalar(s) / an intervalmpt
elseif isa(numerator, 'intervalmpt') == 0 && isa(denominator, 'intervalmpt') == 1
...
% an intervalmpt / an intervalmpt (x / y)
elseif isa(numerator, 'intervalmpt') == 1 && isa(denominator, 'intervalmpt') == 1
